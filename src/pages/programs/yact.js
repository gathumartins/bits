                        ...
                        <Row className={`${proStyles.programContInn}`}>
                            ...
                            <Col xs={12} sm={12} md={5} className={`${proStyles.sideBar} mt-10 py-20 px-4 md:px-2`}>
                                ...
                                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 gap-4 programsPartners">
                                    <li className="d-flex align-items-center"><img src="../imgs/yact.png" alt="NairBits Advanced Multimedia program Edukans" /></li>
                                    <li className="d-flex align-items-center"><img src="../imgs/amref.png" alt="NairBits Advanced Multimedia program Edukans" /></li>
                                </ul>
                            </Col>
                        </Row>
                    </Container>
