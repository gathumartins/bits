            ...
            <section className={teamStyles.contributorsOut}>
                <Container fluid={`md`}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 pb-10">
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Magdalene Wanjugu" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member John Isika" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Sam Nyamwange" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Martin Gathu" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Michelle Tracy" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member John Mwendwa" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Philbert Aganyo" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Tracey Osogo" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Kennedy Wachira" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Hope Nasali" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Edwin Bakker" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Chepkwony kipkoech" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Mariam Zaitun" />
                                <figcaption className="my-3">
                        ...
                        <div className="bitsTeam mb-2">
                            <figure>
                                <img src="./imgs/teamavatar.png" fluid="true" alt="Nairobits Board Member Damaris Muange" />
                                <figcaption className="my-3">
