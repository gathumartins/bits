                    ...
                    <Col xs={12} className={`my-10 grid grid-cols-1 md:grid-cols-2`}>
                        <div className="mb-5">
                            <Row className={`${foundStyles.founder}`}>
                                <Col xs={12} sm={12} md={5} className={`${foundStyles.founderInn}`}>
                                    <StaticImage src="../../images/emer.png" fluid="true" alt="founder Emer Beamer" className="mt-10" />
                                    <div className={foundStyles.founderCapt}>
                                        <h5>Emer Beamer</h5>
                                        <h1>Co-founder NairoBits Trust.</h1>
                                    </div>
                                </Col>
                                <Col xs={12} sm={12} md={7} className={`flex-column align-items-center ${foundStyles.foundCont}`}>
                        ...
                        <div className="mb-5">
                            <Row className={`${foundStyles.founder}`}>
                                <Col xs={12} sm={12} md={5} className={`${foundStyles.founderInn}`}>
                                    <StaticImage src="../../images/ineke.png" fluid="true" alt="founder Ineke Aquarius" className="mt-10" />
                                    <div className={foundStyles.founderCapt}>
